...
def edit_clip(clip, start_on_timeline, end_on_timeline, in_point_on_clip, out_point_on_clip):
    ...
    """
    # not sure about that, we may want the fps of the sequence
    fps = clip.projectItem.getFootageInterpretation().frameRate
    # check length match
